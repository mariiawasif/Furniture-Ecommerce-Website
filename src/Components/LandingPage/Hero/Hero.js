...
function Hero() {
  return (
    <>
      ...
      <HeroContainer>
        <HeroLeft>
          <HeroSubheading>Best Furniture for your castle</HeroSubheading>
          <HeroHeading>
          ...
          <HeroParagraph>
            Elevate your space with our handcrafted, timeless furniture designs. <br />
          </HeroParagraph>
          <ShopButton>Shop Now</ShopButton>
        </HeroLeft>
        <HeroRight>
          <img src={sofa} alt="Hero Image" />
        </HeroRight>
      </HeroContainer>
    </>
  );
